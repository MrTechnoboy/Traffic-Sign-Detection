...
simply use pip install -r requirements.txt. You can also install tensorflow-gpu depending upon the tensorflow version of yours, use any search engine for more information as Tensorflow-GPU is a complex and large topic in itself.
